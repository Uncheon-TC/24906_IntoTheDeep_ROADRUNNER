...
public class Maindrive_test extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        double H_wristL_POS = 0.5;
        double H_wristR_POS = 0.5;
        ...
        while (opModeIsActive()) {
            ...
            if (rising_edge(currentGamepad2.dpad_left, previousGamepad2.dpad_left)) {
                H_wristL_POS = H_wristL_POS + interval;
                H_wristR_POS = H_wristR_POS - interval;
                ...
                wrist_control(H_wristL_POS, H_wristR_POS);
            }
